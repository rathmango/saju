...
|  |  | • **부성과의 갈등/이별** 가능성 매우 높음 |  |

#### 2.2 중대 신호 조합 및 실제 사례

1. **부모 이별/갈등 신호**:
   - **토 과다(3개 이상) + 수 결핍(0개) + 일간 약함**: 모친과 조기 이별 또는 심각한 갈등 가능성 높음
   - **실제 사례 패턴**: 토 과다(미×2, 술) + 수 0개 + 약한 경금 일간 → 어린 시절 모친 관계 어려움 
   - **예외 조건**: 일간이 매우 강하거나, 인성이 시주에 위치할 경우 물리적 이별보다 정서적 거리감으로 나타나는 경향
